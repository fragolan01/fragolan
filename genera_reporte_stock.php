...
if ($manejador) {
    ...
    while (($linea = fgets($manejador)) !== false) {
        ...
        // Dividir la línea en 4 partes usando el tabulador como delimitador
       ...
       echo 'aqui nomas:'. gettype($float_tot_venta_mxn);

            
        // Insertando datos en tabla plataforma_ventas_temp
        $sql_temp = "INSERT INTO plataforma_ventas_temp (id_dominio, id_syscom, orden, fecha, stock, precio, inv_min, status, titulo, mxn_tot_venta) 
