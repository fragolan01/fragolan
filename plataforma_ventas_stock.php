...
if ($v7=="despliega") {
    ...
    $query_plataforma_ventas_stock = "SELECT * FROM plataforma_ventas_stock WHERE id_dominio='".$id_dominio."' ORDER BY nombre";
    ...
    while ($line_plataforma_ventas_stock = mysql_fetch_assoc($result_plataforma_ventas_stock)) {
        ...
        $data_plataforma_ventas_stock3=$line_plataforma_ventas_stock["id_dominio"];
        $data_plataforma_ventas_stock3=$line_plataforma_ventas_stock["id_producto"];
        $data_plataforma_ventas_stock3=$line_plataforma_ventas_stock["fecha"];
        $data_plataforma_ventas_stock3=$line_plataforma_ventas_stock["stock"];
        echo "<nobr>".$data_plataforma_ventas_stock0.".- (<a href='index.php?v7=actualizar&v13=".$data_plataforma_ventas_stock0."'>Actualizar</a> | <a href='index.php?v7=eliminar&v13=".$data_plataforma_ventas_stock0."'>Eliminar</a>) Stock: Nombre: ".$data_plataforma_ventas_stock3."</nobr>";
        echo "<br>";
    }
}
if ($v7=="actualizar") {
    ...
    if ($v13) {
        ...
        echo "<form name='actualiza_plataforma_ventas_stock' method='post' action='index.php?v7=actualizalo&v13=".$v13."'>";
            echo "<nobr>Nombre del Stock: <input type='text' name='nombre' value='".$data_plataforma_ventas_stock3."' size='50'><input type='submit' name='actualizar' value='ACTUALIZAR &raquo;'></nobr>";
        echo "</form>";
    }
    else {
        echo "<br><br>";
        ...
        echo "<form name='inserta_plataforma_ventas_stock' method='post' action='index.php?v7=actualizalo'>";
            echo "<nobr>Nombre del Stock: <input type='text' name='nombre' value='' size='50'><input type='submit' name='insertar' value='INSERTAR &raquo;'></nobr>";
        echo "</form>";
    }
}
if ($v7=="actualizalo") {
    if ($v13) {
        ...
        if (!$nombre) {
            ...
            $sql_plataforma_ventas_stock = "UPDATE plataforma_ventas_stock SET nombre='".$nombre."' WHERE id='".$v13."' AND id_dominio='".$id_dominio."'";
