...
if ($v7=="despliega") {
    ...
    $query_plataforma_ventas_plataformas_publicidad = "SELECT * FROM plataforma_ventas_plataformas_publicidad WHERE id_dominio='".$id_dominio."' ORDER BY id";
    ...
    while ($line_plataforma_ventas_plataformas_publicidad = mysql_fetch_assoc($result_plataforma_ventas_plataformas_publicidad)) {
        ...
        $data_plataforma_ventas_plataformas_publicidad4=$line_plataforma_ventas_plataformas_publicidad["acoss"];
        ...
        echo 
            "<nobr>".
                ...
                $data_plataforma_ventas_plataformas_publicidad3. " Acos: ".
                $data_plataforma_ventas_plataformas_publicidad4.
            "</nobr>";
        echo "<br>";
    }
}
if ($v7=="actualizar") {
    ...
    if ($v13) {
        ...
        $query_plataforma_ventas_plataformas_publicidad = "SELECT id,id_dominio,publicidad,acoss FROM plataforma_ventas_plataformas_publicidad WHERE id='".$v13."' AND id_dominio='".$id_dominio."'";
        $result_plataforma_ventas_plataformas_publicidad = mysql_query($query_plataforma_ventas_plataformas_publicidad) or die('Query failed: plataforma_ventas_plataformas_publicidad ' . mysql_error());
        ...
        echo "<form name='actualiza_plataforma_ventas_plataformas_publicidad' method='post' action='index.php?v7=actualizalo&v13=".$v13."'>";
            echo "<nobr>
                        Publicidad: <input type='text' name='publicidad' value='".$data_plataforma_ventas_plataformas_publicidad3."' size='50'>
                        Acos: <input type='text' name='acoss' value='".$data_plataforma_ventas_plataformas_publicidad4."' size='50'>
        ...
        echo "<form name='inserta_plataforma_ventas_plataformas_publicidad' method='post' action='index.php?v7=actualizalo'>";
            echo "<nobr>
                    Publicidad: <input type='text' name='publicidad' value='' size='50'>
                    Acos: <input type='text' name='acoss' value='' size='50'>
...
if ($v7=="actualizalo") {
    if ($v13) {
        ...
        if (!$publicidad) {
            ...
            $sql_plataforma_ventas_plataformas_publicidad = "UPDATE plataforma_ventas_plataformas_publicidad SET publicidad='".$publicidad."', acoss='".$acoss."' WHERE id='".$v13."' AND id_dominio='".$id_dominio."'";
