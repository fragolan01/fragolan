...
if ($v7=="actualizalo") {
    if ($v13) {
        ...
        if (!$producto) {
            ...
            $sql_plataforma_ventas_productos = "UPDATE plataforma_ventas_productos SET producto='".$producto."', modelo='".$modelo."', num_piezas='".$num_piezas."' WHERE id='".$v13."' AND id_dominio='".$id_dominio."'";
