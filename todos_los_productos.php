...
if ($v7=="despliega") {
    echo "<br><br>";
	echo "<b><a href='index.php?v7=Consulta productos'>CONSULTA &raquo;</a></b>";
    ...
    // $sql = "select * from plataforma_ventas_temp where id_syscom=1445";
    // // $sql ="DELETE FROM plataforma_ventas_temp";
